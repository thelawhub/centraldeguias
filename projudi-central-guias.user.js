...
(function () {
  ...
  (function pjShortcut() {
    // Leader: Ctrl+; libera 1500ms para pressionar G (Guias).
    ...
    function openHere() {
      if (isTop) { try { openManager(); } catch (_) {} }
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .pj-guides-manager__backup-toggles {
        display: flex;
        flex-wrap: wrap;
        align-items: flex-start;
        gap: 10px;
      ...
      .pj-guides-manager__backup-actions {
        display: grid;
        grid-template-columns: repeat(4, minmax(0, 1fr));
        gap: 8px;
        margin-top: 14px;
      }
      .pj-guides-manager__backup-actions .pj-guides-btn {
        min-height: 40px;
        justify-content: center;
      }
      .pj-guides-manager__backup-primary {
        border-color: #1f69d5;
        background: #1f69d5;
        color: #fff;
      }
      .pj-guides-manager__backup-success {
        border-color: #16833a;
        background: #18883f;
        color: #fff;
      }
      ...
      <div class="pj-guides-manager__body">
        ...
        <div id="pj-guides-manager-backup-popover" class="pj-guides-manager__backup-popover">
          <section id="pj-guides-manager-backup" class="pj-guides-manager__backup">
            ...
            <div class="pj-guides-manager__backup-toggles">
